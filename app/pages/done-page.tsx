...
const DonePage = () => {
 ...
 <Text className='text-center text-white font-pressStart2PRegular leading-[32px] text-[16px]'>Done, let’s hop in!</Text>
        <View className="flex-row items-center gap-2 px-8 text-center">
          <Pressable 
            onPress={() => setIsChecked(!isChecked)}
            className={`w-4 h-4 border border-light rounded-sm ${isChecked ? 'bg-red' : ''}`}
          />
          <Text className='font-IbmMedium text-light leading-[14px]'>By continuing you therefore agree 
            to our terms and conditions</Text>
        </View>
        </View>
        </View>
